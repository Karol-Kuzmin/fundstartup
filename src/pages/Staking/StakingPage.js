    ...
    <div>
      <div style={myStyle} className=" lg:h-[749px] h-[100%]  bg-cover">
        ...
        <div className="container mx-auto  grid lg:grid-cols-2 md:grid-cols-1 lg:px-[50px] ">
          <div className="flex justify-center xs:w-[100%] w-[375px]">
            <div className=" lg:w-[100%] w-[80%] ">
              ...
              <div className="lg:justify-start justify-center flex">
                <h5 className="text-[#FFFFFF] xl:text-[18px] lg:text-[16px] md:text-[12px] sm:text-[10px] text-[8px] flex mt-[20px]">
                  {" "}
          ...
          <div className="flex lg:justify-end justify-center lg:mt-[0px] lg:mt-[20px] lg:pb-[0px] pb-[20px] lg:w-[100%] md:w-[100%] w-[375px] md:mt-[20px]">
            <div className=" border-2 border-[#f6b432] rounded-[8px] border-solid  lg:w-[90%] w-[80%] ">
              <div className="  mx-auto w-[95%] h-[493px] ">
                ...
                <div className="mt-[15px] flex  justify-between  gap-4">
                  <button className="w-[97px] h-[43px]  border-2 border-[#f6b432] rounded-[8px] border-solid ">
                    <p
                      className={
                        changeButton2 === "7"
                          ? "pt-[7px] pb-[5px] xl:text-[18px] lg:text-[14px] md:text-[14px] sm:text-[10px] text-[14px] text-[black] font-bold  bg-[#f6b432]"
                          : "pt-[7px] pb-[5px] xl:text-[18px] lg:text-[14px] md:text-[14px] sm:text-[10px] text-[14px] text-[#f6b432] hover:font-bold hover:text-[black] hover:font-bold hover:bg-[#f6b432]"
                      }
                ...
                <div className="mt-[21px] flex justify-between gap-1">
                  <button className="w-[46%] h-[43px] border-2 border-[#f6b432] rounded-[8px] border-solid ">
                    <p
                      className={
                        changeButton2 === "90"
