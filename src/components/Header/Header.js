    ...
    <div>
      <header>
        <nav className="border-gray-200 px-4 lg:px-[39px] py-[3.25rem] ">
          <div className={`flex justify-between items-center mx-auto ${!mobileIconFlag?"":"flex-wrap"}`}>
            ...
            <div
              ...
              id="mobile-menu-2"
            >
              <ul className={`flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 ${!mobileIconFlag?"items-center":""}`}>
                <li>
                  <Link
                    to="#"
